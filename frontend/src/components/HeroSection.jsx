      ...
      <div className="order-2 md:order-1 lg:order-1 flex justify-center lg:justify-start">
        <div className="w-full max-w-sm md:w-80 h-[400px] md:h-[520px] frosted rounded-2xl p-4 md:p-6 shadow-soft-lg relative overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer animate-fade-in-up">
          ...
          <div className="mt-8 md:mt-12 flex flex-col items-center text-center gap-3 md:gap-4">
            ...
            <a href="/signup" className="mt-2 md:mt-4 px-4 md:px-5 py-2 rounded-full bg-[#7c3aed] text-white font-medium text-sm md:text-base">Join as Artist</a>
            <a href="/login" className="mt-1 md:mt-2 px-4 md:px-5 py-2 rounded-full border border-white/10 text-white/90 text-sm md:text-base">Login</a>
          </div>
      ...
      <div className="order-1 md:order-2 lg:order-2 md:col-span-2 lg:col-span-1 flex justify-center">
        <div className="w-full max-w-md md:max-w-lg frosted rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-soft-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer animate-fade-in-up animation-delay-200">
          <div className="flex items-center gap-2 md:gap-3 mb-3">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white">MuzikiMart</h1>
          </div>
          <p className="mt-2 md:mt-3 text-sm md:text-base text-white/80">Global music sharing and concert promotion for artists everywhere.</p>

          <div className="mt-6 md:mt-8 bg-white/6 rounded-xl p-3 md:p-4">
            <div className="flex gap-1 md:gap-2 bg-white/4 p-1 rounded-xl w-full">
              <button className="flex-1 py-2 rounded-lg bg-white/10 text-white font-medium text-sm md:text-base">Login</button>
              <button className="flex-1 py-2 rounded-lg text-white/80 text-sm md:text-base">fanbase Signup</button>
            </div>

            <form className="mt-3 md:mt-4 grid gap-2 md:gap-3">
              <input className="p-2 md:p-3 rounded-lg bg-black/40 text-white placeholder:text-white/60 text-sm md:text-base" placeholder="Email" />
              <input className="p-2 md:p-3 rounded-lg bg-black/40 text-white placeholder:text-white/60 text-sm md:text-base" placeholder="Password" type="password" />
              <div className="flex gap-2 md:gap-3">
                <button className="flex-1 py-2 md:py-3 rounded-xl bg-gradient-to-r from-[#7c3aed] to-[#2dd4bf] font-semibold text-black text-sm md:text-base">Login</button>
                <button className="flex-1 py-2 md:py-3 rounded-xl border border-white/10 text-white text-sm md:text-base">Sign up</button>
              </div>
            </form>

            <p className="text-xs md:text-sm text-white/60 mt-2 md:mt-3">Payments: M-Pesa • Card • PayPal</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm md:max-w-md lg:w-96 h-[400px] md:h-[520px] rounded-2xl frosted p-4 md:p-6 shadow-soft-lg overflow-hidden relative transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer animate-fade-in-up animation-delay-400">
          ...
          <div className="relative h-full flex flex-col justify-between">
            ...
            <div className="mt-3 md:mt-4 flex gap-2 md:gap-3">
              <a className="flex-1 py-2 md:py-3 rounded-xl bg-[#ff8a66] text-black font-semibold text-center text-sm md:text-base">Create Event</a>
              <a className="flex-1 py-2 md:py-3 rounded-xl border border-white/8 text-white text-center text-sm md:text-base">Explore</a>
            </div>
          </div>
